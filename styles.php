            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <h3>Media Object</h3>
                        <div class="media">
                            <img class="d-flex mr-3" src="https://dummyimage.com/60x60/563d7c/fff"
                                alt="Generic placeholder image">
                            <div class="media-body">
                                <h5 class="mt-0">Media heading</h5> Media object description text
                                <div class="media mt-3">
                                    <a class="d-flex pr-3" href="#">
                                        <img src="https://dummyimage.com/60x60/563d7c/fff"
                                            alt="Generic placeholder image">
                                    </a>
                                    <div class="media-body">
                                        <h5 class="mt-0">Media heading</h5> Media object description text
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <blockquote class="blockquote">
                            <p class="mb-0">Typography is to literature as musical performance is to composition: an
                                essential act
                                of interpretation, full of endless opportunities for insight or obtuseness.</p>
                            <footer class="blockquote-footer">Robert Bringhurst in <cite title="Source Title">The
                                    Elements of
                                    Typographic Style</cite></footer>
                        </blockquote>
                        <h3>Table</h3>
                        <table class="table ">
                    ...
                    <div class="col-sm-6">
                        ...
                        <h3>Lead</h3>
                        <p class="lead">A lead paragraph is used to draw a reader into the body copy. In a badly
                            designed book, the
                            letters mill and stand like starving horses in a field. In a book designed by rote, they sit
                            like stale
                            bread and mutton on the page.</p>
                        <p>In a well-made book, where designer, compositor and printer have all done their jobs, no
                            matter how many
                            thousands of lines and pages, the letters are alive. They dance in their seats. Sometimes
                            they rise and
                            dance in the margins and aisles.</p>
                        <h3>Unstyled List</h3>
                        <ul class="list-unstyled">
                            <li>Unstyled list item text</li>
                            <li>Unstyled list item text
                                <ul>
                                    <li>Nested list items need the <code>.list-unstyled</code> class as well or they
                                        will have
                                        bullets</li>
                                </ul>
                            </li>
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-9">Definition list description etiam porta sem malesuada magna mollis
                                euismod.</dd>
                            <dt class="col-sm-3 text-truncate">Long title that <strong>is</strong> truncated or
                                shortened</dt>
                            <dd class="col-sm-9">Definition list description etiam porta sem malesuada magna mollis
                                euismod.</dd>
                            ...
                            <dd class="col-sm-9">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-8">Definition list description etiam porta sem malesuada magna
                                        mollis euismod.
                                    </dd>
                                </dl>
                            </dd>
                        ...
                        <h3>Figure</h3>
                        <figure class="figure">
                            <img src="https://dummyimage.com/400x200/563d7c/fff" class="figure-img img-fluid rounded"
                                alt>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <h3>Popover</h3>
                        <a tabindex="0" class="btn btn-lg btn-primary" role="button" data-toggle="popover"
                            data-trigger="focus" title="Dismissible popover"
                            data-content="And here's some amazing content. It's very engaging. Right?">Popover on
                            click</a>
                        <br /><br /><br />
                        <button type="button" class="btn btn-lg btn-primary" data-toggle="popover" data-trigger="hover"
                            data-delay="300" title="Popover title" data-content="Popover description text">Popover on
                            hover</button>
                        <h3>Card</h3>
                            ...
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse show" role="tabpanel"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <img src="https://dummyimage.com/200x200/563d7c/fff" alt
                        ...
                        <div class="list-group">
                            <a href="#"
                                ...
                                <p class="mb-1">Description text gravida at eget metus. Maecenas sed diam eget risus
                                    varius blandit.
                                </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <p><button type="button" class="btn btn-outline-primary btn-sm">Primary Outline</button>
                                </p>
                                <p><button type="button" class="btn btn-outline-primary">Primary Outline</button></p>
                                <p><button type="button" class="btn btn-outline-primary btn-lg">Primary Outline</button>
                                </p>
                                <p><button type="button" class="btn btn-outline-secondary btn-sm">Secondary
                                        Outline</button></p>
                                <p><button type="button" class="btn btn-outline-secondary">Secondary Outline</button>
                                </p>
                                <p><button type="button" class="btn btn-outline-secondary btn-lg">Secondary
                                        Outline</button></p>
                            </div>
                        ...
                        <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right"
                            data-html="true"
                            title="<img src=https://dummyimage.com/100x80/563d7c/fff alt= class=img-thumbnail img-fluid><h4>Tooltip</h4> <u>with</u> <b>HTML</b>">
                    ...
                    <div class="col-sm-6">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img class="d-block img-fluid"
                                        src="https://dummyimage.com/900x340/563d7c/fff&text=+" alt="First slide">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block img-fluid"
                                        src="https://dummyimage.com/900x340/563d7c/fff&text=+" alt="Second slide">
                                    <div class="carousel-caption d-none d-md-block">
                                        <h3>Carousel Slider Title</h3>
                                        <p>Description text to further describe the content of the slide image</p>
                                        <a href class="btn btn-primary">Call to Action</a>
                                ...
                                <div class="carousel-item">
                                    <img class="d-block img-fluid"
                                        src="https://dummyimage.com/900x340/563d7c/fff&text=+" alt="Third slide">
                                    <div class="carousel-caption d-none d-md-block">
                                        <h3>Carousel Slider Title</h3>
                                        <p>Description text to further describe the content of the slide image</p>
                                        <a href class="btn btn-primary">Call to Action</a>
                        ...
                        <div class="jumbotron">
                            ...
                            <p class="lead">A component for calling extra attention to featured content or information.
                            </p>
                            <hr class="my-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <small id="emailHelp" class="form-text text-light"><a href>Forgot Password?</a>
                                            / <a href>Sign Up</a></small>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="bd-example">
                            ...
                            <div data-spy="scroll" data-target="#navbar-example2" data-offset="0"
                                ...
                                <p>The ScrollSpy plugin auto updates nav targets as you scroll the area below the
                                    navbar. Also works
                                    in dropdowns as well.</p>
                                <h4 id="use">Use Cases</h4>
                                <ul>
                                    <li>For long pages of documentation</li>
                                    <li>One page website with sticky top navbar</li>
                                    <li>A grid of images for a portfolio that identifies categories as you scroll down
                                        the page. For
                                        example: print, web, photography, etc.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
