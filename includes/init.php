...
include_once 'metadata/default/pagesettings.php'; //constants - project default pages - we should try to phase this in favor of using infofiles
include_once 'metadata/default/variablemapping.php'; //constants - project default variable mappings
