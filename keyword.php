...
if (is_file($url)) {
    ...
    $h1Title = (isset($page[0]['keyword'])) ? $page[0]['keyword'] : '';
    $page_title .= ': ' . $h1Title;
    ...
    <div class="container bg-white px-0">
        ...
        <div id="idExpt" class="p-0 mb-0">
            <div id="greenTitle" class="d-flex  mb-3 py-3 p3-3 bg-info text-white mt-0 ">
                <h1 class="mx-3">e-RAsearch - Keyword search</h1>
            </div>
            <div class="row">
                <div class="col-3">
...
$datasets = isset($page[0]['datasets']) ? $page[0]['datasets'] : array();
if (count($datasets)) {
...
?>
                ...
                <div class="col-9">
                    <h2>e-RAsearch: <?php echo $page[0]['keyword'];?></h2>
			...
			if ($sendSearch == "Search" ) {
                        ...
                        $documents = array();
                        $documents = (isset($page[0]['documents'])) ? $page[0]['documents']: array("no documents");
                        $countDocs = 0;
                        $stringDoc = '';
                ...
                foreach ($data as $keywords)
                {
                    ...
                    $size = $countDS + 12;
                    if ($size > 40) {$size = 40;}
                    echo  "<span  style=\"font-size:".$size."px;\" > <a href=\"keyword/".$keywords['slug']."\">".$keywords['keyword']. "</a></span> ";
                }
                }
                echo ("</div>");
?>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#result').on('click', 'li', function () {
                    ...
                    let word = $(this).text().trim().replace(/ /g,"-").toLowerCase();
